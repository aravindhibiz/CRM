-- Relax RLS policies on deals and contacts to allow all authenticated users to view them.
-- This is necessary for the activity timeline to correctly join and display related data.

-- 1. Update Deals Policies
...
-- Re-create specific policies for write operations (INSERT, UPDATE, DELETE)
