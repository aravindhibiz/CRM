...
-- Create new SELECT policies that allow any authenticated user to view all records.
...
-- Re-apply policies for INSERT, UPDATE, DELETE to ensure users can still manage their own records.
